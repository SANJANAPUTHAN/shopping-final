...
<div class="container" >
			...
			<blockquote class="blockquote">
				<h3 style="font-family: 'Rubik', sans-serif;">Search Invoice By ID</h3>
			</blockquote>
		</figure>
	<form class="row g-3" action="/manager/invoice"
		...
		<div style="padding:0% 1% 1% 20%">
			<div class="col-md-9" >
				<input type="text" class="form-control" id="inputEmail4" name="invno" placeholder="Invoice Id" required>
			</div>
		</div>
