		...
		<div class="row row-cols-1 row-cols-md-3 g-4">
			<form action="/manager/getAddAdmin" method="get">
				...
				<div class="col-sm">
					<div class="card">
						<div class="card-body text-center">
							<h5 class="card-title ">Check Invoice by Date</h5>
							<p class="card-text">Check the Invoice using From and To date</p>
							<input class="btn btn-danger" type="submit" value="Generate" name="delete">
						</div>
					</div>
				</div>
			...
			<form action="/manager/getInvoiceCustId" method="post">
				<div class="col-sm">
					<div class="card">
						<div class="card-body text-center">
							<h5 class="card-title">Check Invoice by Customer ID</h5>
							<p class="card-text">Check the Invoice using Customer Id</p>
							<input class="btn btn-danger" type="submit" value="Generate" name="delete">
						</div>
					</div>
				</div>
			...
			<form action="/manager/getInvoiceID" method="post">
				<div class="col-sm">
					<div class="card">
						<div class="card-body text-center">
							<h5 class="card-title">Check Invoice by ID</h5>
