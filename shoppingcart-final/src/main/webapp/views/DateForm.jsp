...
<div class="user_card">
<div class="container" >
				<figure class="text-center" style="padding:1% 1% 1% 3%;">
			<blockquote class="blockquote">
				<h3 style="font-family: 'Rubik', sans-serif;">Search Invoice</h3>
			</blockquote>
		</figure>
		...
		<div style="padding-left: 100px; padding-bottom: 5px;">
			<div class="col-md-9" >
				...
				<input
					type="date" class="form-control" id="inputEmail4" name="sdate" required>
			</div>
			<div class="col-md-9">
				<label for="inputPassword4" class="form-label">Invoice End Date</label>
				<input
					type="date" class="form-control" id="inputPassword4" name="edate" required>
			</div>
		</div>
