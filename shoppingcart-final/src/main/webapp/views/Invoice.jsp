...
<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-danger">
  ...
  <div class="container">
	...
	<div class="user_card">
	<div class="container">
	 <marquee style="border:black dashed 3px; color:red;" onMouseOver="this.stop()" onMouseOut="this.start()">${sessionScope.estimate}</marquee>
		...
		<span style="margin-left:400px; padding-right:30px;">
				<button class="btn btn-danger" name="action" value="cancel" type="submit">Cancel Invoice</button>
		</span>
			<span>
				<button class="btn btn-danger" name="action" value="generate" type="submit">Generate Invoice</button>
			</span>
